...
So we can imagine how the matrix is going to look: the terms of second derivative in x-direction will be adjacent to each other, but they terms of the second derivative in y-direction will be offset by N points. This will become clear in the visual representation below.
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \texttt{Variable} & \texttt{Dimension} & \texttt{Memory} & \texttt{Comments}\\
            \hline
            \texttt{T}&\texttt{(N+1)}\texttt{(N+1)}&\texttt{8}$\times$\texttt{(N+1)}\texttt{(N+1)}&\\
            \hline
            \texttt{q}&\texttt{(N+1)}\texttt{(N+1)}&\texttt{8}$\times$\texttt{(N+1)}\texttt{(N+1)}&\\
            \hline
            \texttt{A}&\texttt{(N+1)}\texttt{(N+1)}$\times$\texttt{(N+1)}\texttt{(N+1)}&\texttt{8}$\times$\texttt{5}&\\
            \hline
            \texttt{N}&\texttt{1}&\texttt{4}&\\
            \hline
            \texttt{N}&\texttt{1}&\texttt{4}&\\
            ...
            \texttt{k}&\texttt{1}&\texttt{8}&\\
            \hline
            &\texttt{Total} &\texttt{16(N+1)(N+1)+80}&\\ 
            \hline
            \end{tabular}}\\
            \end{table} 
        ...
        \begin{itemize}
            ...
            \texttt{q}&\texttt{(N+1)}\texttt{(N+1)}&\texttt{8}$\times$\texttt{(N+1)}\texttt{(N+1)}&\\
            \hline
            \texttt{A}&\texttt{(N+1)}\texttt{(N+1)}$\times$\texttt{(N+1)}\texttt{(N+1)}&\texttt{8}$\times$\texttt{9}&\\
            \hline
            \texttt{N}&\texttt{1}&\texttt{4}&\\
            \hline
            \texttt{N}&\texttt{1}&\texttt{4}&\\
            ...
            \texttt{k}&\texttt{1}&\texttt{8}&\\
            \hline
            &\texttt{Total} &\texttt{16(N+1)(N+1)+120}&\\ 
            \hline
